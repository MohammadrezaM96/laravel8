            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" class="myForm"
                          action="{{ route('instagram.update' , $post->id) }}">
                        @csrf
                        <div class="col-md-12 mt-3">
                            <div class="input-field">
                                <input placeholder="لینک پست" class="form-control" name="post_link" type="text"
                                       id="post_link" value="{{ $post->post_link ?? '-' }}" required="">
                                <label for="post_link">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <span class="input-group-btn">
                                ...
                                <input id="image" class="form-control" type="text" name="image_link"
                                       required="" value="{{ $post->image_link }}">
                            </div>
                            <img id="holderIcon2" style="margin-top:15px;height:400px;width: 400px;"
                                 src="{{\Illuminate\Support\Facades\URL::to('/').'/'.$post->image_link}}">
                        </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary myCheckbox mt-2">
                                    <input
                                        ...
                                        type="checkbox"
                                        value="1"
                                        @if($post->is_video == 1) checked @endif>
