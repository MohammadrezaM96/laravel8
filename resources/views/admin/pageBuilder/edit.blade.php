                        ...
                        <div class="col-md-12 mt-3">
                            <div class="input-field">
                                <input placeholder="عنوان صفحه" class="form-control" name="title" type="text"
                                       id="title" value="{{ $page->title }}" required="">
                                <label for="title">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="input-field">
                                ...
                                <textarea class="form-control" name="tiny_description" rows="3"
                                          class="">{!! $page->tiny_description ?? old('tiny_description')!!}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary myCheckbox mt-2">
                                    <input
                                        ...
                                        type="checkbox"
                                        value="1"
                                    @if($page->show_header == 1) checked @endif>
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary myCheckbox mt-2">
                                    <input
                                        ...
                                        type="checkbox"
                                        value="1"
                                    @if($page->show_footer == 1) checked @endif>
