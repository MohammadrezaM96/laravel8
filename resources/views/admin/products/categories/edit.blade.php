...
@section('title')
   ویرایش دسته بندی {{ $productCategory->name }}
@endsection
                ...
                <div class="form-row justify-content-start ">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-field">
                                                    <input type="text" class="form-control"
                                                           ...
                                                           value="{{ $productCategory->translate($lang->key)->name }}">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <div class="input-field">
                                                    <textarea class="form-control" name="{{ $lang->key . '_description' }}"
                                                              ...
                                                              required="">{{ $productCategory->translate($lang->key)->description }}</textarea>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="input-field">
                            <textarea class="form-control" name="meta_description" id="meta_description" rows="3"
                                      required="">{{ $productCategory->meta_description }}</textarea>
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="image" class="form-control" type="text" name="image" value="{{ $productCategory->image }}">
                        </div>
                        <img src="{{ url($productCategory->image) }}" id="holder" style="margin-top:15px;max-height:200px;">
                    </div>
