...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="myForm needs-validation categoryForm"
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div class="input-field">
                                                            ...
                                                            <input placeholder="نام محصول({{ $lang->name }})"
                                                                   ...
                                                                   id="{{ $lang->key . '_name' }}"
                                                                   value="{{ $product->translate($lang->key)->name ?? '' }}">
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div class="input-field">
                                                            ...
                                                            <textarea id="my-editor-{{ $lang->key }}"
                                                                      ...
                                                                      class="">{!! $product->translate($lang->key)->description ?? '' !!}</textarea>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <div class="dropdown bootstrap-select rounded">
                                    <select class="selectpicker rounded"
                                        ...
                                        @foreach($subs as $sub)
                                            <option value="{{ $sub->id }}"
                                                    @if($product->sub_id == $sub->id)selected @endif
                                            >
                                                {{ $sub->name ?? '-' }}
                                            </option>
                                        @endforeach
                                    ...
                                    <select class="selectpicker rounded"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{ $city->id }}"
                                                    @if($product->city_id == $city->id) selected @endif>
                                                {{ $city->name ?? '-' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="input-field">
                                    <input placeholder="کد محصول" class="form-control" name="code" type="text"
                                           id="code" value="{{ $product->code }}" required="">
                                    <label for="code">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="input-field">
                                    <input placeholder="متراژ" class="form-control" name="meter" type="number"
                                           id="meter" value="{{ $product->meter }}" required="">
                                    <label for="meter">
                                        <p class="m-0"> متراژ </p>
                                    </label>
                                    <div class="valid-tooltip">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="input-field">
                                    <input placeholder="تعداد اتاق خواب" class="form-control" name="bedroom"
                                           type="number"
                                           id="bedroom" value="{{ $product->bedroom }}" required="">
                                    <label for="bedroom">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="input-field">
                                    <input placeholder="سال ساخت" class="form-control" name="year_of_construction"
                                           type="number"
                                           id="year_of_construction" value="{{ $product->year_of_construction }}"
                                           required="">
                                ...
                                <a href="#" id="lfm2" data-input="image" data-preview="holderIcon2"
                                   class="btn btn-primary">
                                    ...
                                    <input id="image" class="form-control" type="text" name="image"
                                           required=""
                                           value="{{ $product->medias()->where('type' , 'cover')->first()->src ?? '' }}">
                                </div>
                                <img src="{{ url($product->medias()->where('type' , 'cover')->first()->src ?? '') }}"
                                     id="holderIcon2" style="margin-top:15px;height:619px;width: 100%;">
                            </div>
                                    ...
                                    <div class="form-group m-0">
                                        <div class="checkbox checkbox-primary myCheckbox mt-2">
                                            <input
                                                ...
                                                type="checkbox"
                                                value="{{ $attribute->id }}"
                                                @if($product->attributes->contains($attribute->id)) checked @endif>
...
@section('script')
    ...
    <script>
        let preload = @json($productGallery)
    </script>
